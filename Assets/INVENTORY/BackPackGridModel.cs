...
public class BackPackGridModel : InventoryGridModelBase
{
    public BackPackGridModel(InventoryGridConfig gridConfig) : base(gridConfig)
    {
    }
